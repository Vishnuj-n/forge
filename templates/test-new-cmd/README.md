# Template: test-new-cmd

## Overview

This is a Forge template for bootstrapping test-new-cmd projects.
...
Run: forge test templates/test-new-cmd

### Use the template

Run: forge init templates/test-new-cmd ./my-project
