...
```
my-template/
├── template.yaml      # Configuration (Required)
├── README.md          # Documentation (Recommended)
├── files/             # Files to copy (Optional)
│   ├── src/
│   │   └── main.py
│   └── config.json
└── patches/           # Files to append (Optional)
    ├── .gitignore.append
    └── .env.append
```
...
## 📝 Example: Python Project with Git
